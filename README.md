# 5.1 GuessTheWord :earth_africa:

## Descripcion
Se dara comienzo a una pequeña aplicacion, en el que un jugador debe adivinar la palabra que se muestre en pantalla con ayuda de las pistas que el resto de participantes le den. Con este proyecto se trabaja con los componentes de la arquitectura, el ViewModel y el ViewModelFactory.
...
Asimismo es necesario tener conocimientos sobre como utilizar componentes, ademas de pasar los datos entre diferentes destinos de navegacion.
